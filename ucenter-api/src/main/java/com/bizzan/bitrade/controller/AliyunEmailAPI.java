...
public class AliyunEmailAPI {
    ...
    private final static String AccessKeyId = "LTAI5tGV7yvLJcAyZvLXiqWe";
    private final static String AccessKeySecret = "dg2CXEP35PBJP7OxwEjPsMcGFGpWcY";
    //发信地址
    private final static String AccountName = "server@btearn.org";
    ...
    private final static String TagName = "BTEARN";
