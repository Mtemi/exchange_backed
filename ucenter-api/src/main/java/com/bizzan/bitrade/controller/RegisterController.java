...
public class RegisterController {
    ...
    // 邮件配置
    private IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAI5tGV7yvLJcAyZvLXiqWe", "dg2CXEP35PBJP7OxwEjPsMcGFGpWcY");
...
//    }
    ...
    public String activate(String key, HttpServletRequest request) throws Exception {
        ...
        member.setAvatar("https://btearn.oss-ap-southeast-3.aliyuncs.com/defaultavatar.png"); // 默认用户头像
